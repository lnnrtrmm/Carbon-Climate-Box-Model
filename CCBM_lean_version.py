...
class EnergyAndCarbonBoxModel:
    ...
    def __init__(self, co2_emissions, ERF_nonco2, sy=1850, ey=2300, dt=1.0,
        ...
        self.ERF_nonco2 = ERF_nonco2               # This is external models input
        self.ERF_co2    = np.zeros((self.nyears))  # This is calculated
        
        
        self.CarbonModel = CarbonBoxModel(co2_emissions, sy=self.startyear, ey=self.endyear,
    ...
    def spinup(self, co2fix=283.0, years=3000, silent=False):
        ...
        self.SpinupModel = CarbonBoxModel(zero_emissions, sy=0, ey=years, dt=self.dt,
                                          lfix_co2=True, co2fix=co2fix, isSpinup=True,
        ...
        for i in range(0,ny-1): self.SpinupModel.step_forward(i, 0.0)
    ...
    def integrate(self, silent=False):
        ...
        for i in range(0,self.nyears-1):
            ...
            self.CarbonModel.step_forward(i, self.T_surf[i])
...
class CarbonBoxModel:
    ...
    def step_forward(self, i, T_surf):     
